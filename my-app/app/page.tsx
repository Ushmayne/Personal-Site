      ...
      <div className="ml-auto">
        ...
        <div className="mt-6 space-y-3">
          ...
          <a 
            ...
            className="flex items-center gap-3 text-cabin-muted hover:text-cabin-rain transition-colors"
          >
          ...
          >
            ...
            <span>LinkedIn: Mohammad Usman</span>
          </a>
          ...
          {/* Location */}
          <div className="flex items-center gap-3 text-cabin-muted">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
